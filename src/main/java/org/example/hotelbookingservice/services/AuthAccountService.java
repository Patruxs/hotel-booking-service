...
public class AuthAccountService {
    ...
    public record TokenIssue(TokenResponse response, String refreshToken, Instant refreshExpiresAt) {
    }

    private record AccountRow(UUID id, String email, String passwordHash, String firstName, String lastName, boolean emailVerified, String avatarUrl, Instant createdAt, Instant updatedAt) {
    }
