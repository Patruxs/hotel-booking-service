    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Badge variant={STATUS_CONFIG[contact.status as keyof typeof STATUS_CONFIG].variant} className="text-lg px-4 py-2">
            {STATUS_CONFIG[contact.status as keyof typeof STATUS_CONFIG].label}
          </Badge>
        </div>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
