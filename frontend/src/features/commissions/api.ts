...
export const commissionsApi = {
  ...
  assignToHotel: (hotelId: string, commissionPackageId: string) =>
    mockOrRequest({ ok: true }, () => api.patch(`/admin/commission-packages/${hotelId}/commission-package`, { commissionPackageId })),
